...
```
Task(
  prompt="Read /Users/ng/Desktop/fuzzyband/.cursor/agents/gsd-security-auditor.md for instructions.\n\n" +
...
**State B (create):**
1. Read template from `/Users/ng/Desktop/fuzzyband/.cursor/get-shit-done/templates/SECURITY.md`
