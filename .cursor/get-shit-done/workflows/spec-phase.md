...
```bash
INIT=$(node "/Users/ng/Desktop/fuzzyband/.cursor/get-shit-done/bin/gsd-tools.cjs" init phase-op "${PHASE}")
...
Use the SPEC.md template from @/Users/ng/Desktop/fuzzyband/.cursor/get-shit-done/templates/spec.md.
