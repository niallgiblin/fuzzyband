...
<required_reading>
@/Users/ng/Desktop/fuzzyband/.cursor/get-shit-done/references/ai-frameworks.md
@/Users/ng/Desktop/fuzzyband/.cursor/get-shit-done/references/ai-evals.md
</required_reading>
...
```markdown
Read /Users/ng/Desktop/fuzzyband/.cursor/agents/gsd-framework-selector.md for instructions.
...
Copy template:
```bash
cp "/Users/ng/Desktop/fuzzyband/.cursor/get-shit-done/templates/AI-SPEC.md" "${PHASE_DIR}/${PADDED_PHASE}-AI-SPEC.md"
```
...
```markdown
Read /Users/ng/Desktop/fuzzyband/.cursor/agents/gsd-ai-researcher.md for instructions.
...
```markdown
Read /Users/ng/Desktop/fuzzyband/.cursor/agents/gsd-domain-researcher.md for instructions.
...
```markdown
Read /Users/ng/Desktop/fuzzyband/.cursor/agents/gsd-eval-planner.md for instructions.
