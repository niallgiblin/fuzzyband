...
- **Global scope**: `/Users/ng/Desktop/fuzzyband/.cursor/notes/{YYYY-MM-DD}-{slug}.md` — fallback when no `.planning/`, or when `--global` flag is present
...
2. Ensure the notes directory exists (`.planning/notes/` or `/Users/ng/Desktop/fuzzyband/.cursor/notes/`)
...
2. Glob `/Users/ng/Desktop/fuzzyband/.cursor/notes/*.md` (if directory exists) — global notes
...
Global (/Users/ng/Desktop/fuzzyband/.cursor/notes/):
...
2. **No `.planning/`**: Falls back to global `/Users/ng/Desktop/fuzzyband/.cursor/notes/` — works in any directory
