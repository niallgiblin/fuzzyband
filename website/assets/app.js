  ...
  const PRODUCTS = [
    {
      ...
      buildNote: "Requires ONNX Runtime (macOS: `brew install onnxruntime`)",
    },
    {
      id: "fairo",
      name: "Fairo",
      ...
      desc: "A physically-informed model of the Black Arts Toneworks Pharaoh fuzz: switchable clipping (Si/Ge/bypass) and the coupled Tone/High tonestack.",
      buildCmd: [
