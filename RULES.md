...
**Authority:** verified against live source at **v1.0.26** (`CMakeLists.txt` line 4).  
...
*Last verified against source: v1.0.26. When behaviour changes, update this file in the same change that updates the code — do not leave it to a later “docs pass.”*
